...
create or replace function processGenSeqData(shingleLength int) returns
setof numeric
as
$$
		with gen1_len as (select distinct aa_sequence --уникальные шинглы первого генома
			 ...
			 intersection_len2 as (select count(*) as cnt from gen1_len g1 --пере сечение уникальных шинглов
			 				inner join gen2_len g2 on g1.aa_sequence = g2.aa_sequence),
			 union_len2 as (select count(inner_.*) as cnt from (select * from gen1_len g1 --объединение уникальных шинглов
									union all
